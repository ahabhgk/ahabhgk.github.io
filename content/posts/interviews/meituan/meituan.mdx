...
1. https 怎么进行加密
    ...
    主要是三方面：加密、完整性验证、证书验证，一开始没想到第三点，后来提醒打上来了，之后深入的问 CA 各个级之间如何验证没答上来
