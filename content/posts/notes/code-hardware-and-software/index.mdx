...
Intel Core-i7-7700HQ 2.8GHz：2.8GHz 表示 CPU 在 1 秒时间内，可以执行的简单指令的数量是 2.8G 条。其时钟周期时间就是 1 / 2.8G，频率越高执行时间越小

CPU 性能优化：

1. 提高频率，摩尔定律

2. 减少每条指令的平均时钟周期数 CPI，现代 CPU 通过流水线技术（Pipeline）来减少 CPI
